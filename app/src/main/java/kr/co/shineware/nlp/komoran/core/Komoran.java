...
public class Komoran implements Cloneable{
	...
	public Komoran(ObjectInputStream ois_IrregularTrie, ObjectInputStream ois_observation, BufferedReader br_posTable, ObjectInputStream ois_transition){
		this.resources = new Resources();
		this.load(ois_IrregularTrie ,ois_observation, br_posTable, ois_transition);
	...
	private Map<String, List<IrregularNode>> getIrregularNodes(char jaso) {
		// getTrieDictionary() returns 	AhoCorasickDictionary<List<IrregularNode>>;
	...
	{
		this.resources.load(ois_IrregularTrie ,ois_observation, br_posTable, ois_transition);
	}
